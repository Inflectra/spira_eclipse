...
public class ISoapServiceRequirementDeleteServiceFaultMessageFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public ISoapServiceRequirementDeleteServiceFaultMessageFaultFaultMessage(String message, ServiceFaultMessage faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ISoapServiceRequirementDeleteServiceFaultMessageFaultFaultMessage(String message, ServiceFaultMessage faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
