 ...
 *       &lt;sequence>
 *         &lt;element name="Incident_AddStatusResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}RemoteIncidentStatus" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class IncidentAddStatusResponse {
    ...
    @XmlElementRef(name = "Incident_AddStatusResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setIncidentAddStatusResult(JAXBElement<RemoteIncidentStatus> value) {
        this.incidentAddStatusResult = value;
    }
