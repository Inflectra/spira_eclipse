 ...
 *       &lt;sequence>
 *         &lt;element name="TestRun_CreateFromTestSetResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v4_0.DataObjects}ArrayOfRemoteManualTestRun" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TestRunCreateFromTestSetResponse {
    ...
    @XmlElementRef(name = "TestRun_CreateFromTestSetResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v4.0/", type = JAXBElement.class)
