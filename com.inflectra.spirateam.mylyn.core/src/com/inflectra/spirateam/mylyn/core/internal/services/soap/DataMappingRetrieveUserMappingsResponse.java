 ...
 *       &lt;sequence>
 *         &lt;element name="DataMapping_RetrieveUserMappingsResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteDataMapping" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DataMappingRetrieveUserMappingsResponse {
    ...
    @XmlElementRef(name = "DataMapping_RetrieveUserMappingsResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
