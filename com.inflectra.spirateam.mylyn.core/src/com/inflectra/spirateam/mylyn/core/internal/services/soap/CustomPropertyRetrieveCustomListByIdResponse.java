 ...
 *       &lt;sequence>
 *         &lt;element name="CustomProperty_RetrieveCustomListByIdResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}RemoteCustomList" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CustomPropertyRetrieveCustomListByIdResponse {
    ...
    @XmlElementRef(name = "CustomProperty_RetrieveCustomListByIdResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setCustomPropertyRetrieveCustomListByIdResult(JAXBElement<RemoteCustomList> value) {
        this.customPropertyRetrieveCustomListByIdResult = value;
    }
