 ...
 *       &lt;sequence>
 *         &lt;element name="TestRun_RetrieveManualResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteManualTestRun" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TestRunRetrieveManualResponse {
    ...
    @XmlElementRef(name = "TestRun_RetrieveManualResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setTestRunRetrieveManualResult(JAXBElement<ArrayOfRemoteManualTestRun> value) {
        this.testRunRetrieveManualResult = value;
    }
