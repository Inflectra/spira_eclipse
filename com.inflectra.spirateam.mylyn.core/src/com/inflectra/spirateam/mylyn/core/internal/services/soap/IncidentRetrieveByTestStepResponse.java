 ...
 *       &lt;sequence>
 *         &lt;element name="Incident_RetrieveByTestStepResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v4_0.DataObjects}ArrayOfRemoteIncident" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class IncidentRetrieveByTestStepResponse {
    ...
    @XmlElementRef(name = "Incident_RetrieveByTestStepResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v4.0/", type = JAXBElement.class)
    ...
    public void setIncidentRetrieveByTestStepResult(JAXBElement<ArrayOfRemoteIncident> value) {
        this.incidentRetrieveByTestStepResult = ((JAXBElement<ArrayOfRemoteIncident> ) value);
    }
