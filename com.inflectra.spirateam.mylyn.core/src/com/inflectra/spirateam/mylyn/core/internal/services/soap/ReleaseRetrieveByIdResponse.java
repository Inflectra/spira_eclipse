...
public class ReleaseRetrieveByIdResponse {
    ...
    /**
     * Gets the value of the releaseRetrieveByIdResult property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<RemoteRelease> getReleaseRetrieveByIdResult() {
        return releaseRetrieveByIdResult;
    }

    /**
     * Sets the value of the releaseRetrieveByIdResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link RemoteRelease }{@code >}
