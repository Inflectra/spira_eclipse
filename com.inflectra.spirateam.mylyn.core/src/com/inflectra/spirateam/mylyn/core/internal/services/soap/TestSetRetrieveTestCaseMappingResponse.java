 ...
 *       &lt;sequence>
 *         &lt;element name="TestSet_RetrieveTestCaseMappingResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteTestSetTestCaseMapping" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TestSetRetrieveTestCaseMappingResponse {
    ...
    @XmlElementRef(name = "TestSet_RetrieveTestCaseMappingResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setTestSetRetrieveTestCaseMappingResult(JAXBElement<ArrayOfRemoteTestSetTestCaseMapping> value) {
        this.testSetRetrieveTestCaseMappingResult = value;
    }
