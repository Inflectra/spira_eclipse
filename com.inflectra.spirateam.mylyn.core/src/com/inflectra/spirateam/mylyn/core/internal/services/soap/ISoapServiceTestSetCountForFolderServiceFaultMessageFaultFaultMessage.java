...
public class ISoapServiceTestSetCountForFolderServiceFaultMessageFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public ISoapServiceTestSetCountForFolderServiceFaultMessageFaultFaultMessage(String message, ServiceFaultMessage faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ISoapServiceTestSetCountForFolderServiceFaultMessageFaultFaultMessage(String message, ServiceFaultMessage faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
