 ...
 *       &lt;sequence>
 *         &lt;element name="Project_RetrieveUserMembershipResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteProjectUser" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ProjectRetrieveUserMembershipResponse {
    ...
    @XmlElementRef(name = "Project_RetrieveUserMembershipResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
