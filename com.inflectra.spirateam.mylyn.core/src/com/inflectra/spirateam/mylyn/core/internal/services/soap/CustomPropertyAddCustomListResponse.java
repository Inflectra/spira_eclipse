 ...
 *       &lt;sequence>
 *         &lt;element name="CustomProperty_AddCustomListResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}RemoteCustomList" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CustomPropertyAddCustomListResponse {
    ...
    @XmlElementRef(name = "CustomProperty_AddCustomListResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setCustomPropertyAddCustomListResult(JAXBElement<RemoteCustomList> value) {
        this.customPropertyAddCustomListResult = value;
    }
