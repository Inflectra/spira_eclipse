 ...
 *         &lt;element name="CustomPropertyValueId" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
...
@XmlType(name = "RemoteCustomListValue", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v4_0.DataObjects", propOrder = {
...
public class RemoteCustomListValue {
    ...
    @XmlElementRef(name = "CustomPropertyValueId", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v4_0.DataObjects", type = JAXBElement.class)
    protected JAXBElement<Integer> customPropertyValueId;
     ...
     *     
     */
    public JAXBElement<Integer> getCustomPropertyValueId() {
     ...
     *     
     */
    public void setCustomPropertyValueId(JAXBElement<Integer> value) {
        this.customPropertyValueId = ((JAXBElement<Integer> ) value);
    }
