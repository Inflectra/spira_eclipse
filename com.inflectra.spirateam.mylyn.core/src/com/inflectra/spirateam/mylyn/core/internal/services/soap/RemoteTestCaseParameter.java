...
@XmlType(name = "RemoteTestCaseParameter", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", propOrder = {
    "defaultValue",
    "name",
    "testCaseId",
    "testCaseParameterId"
...
public class RemoteTestCaseParameter {
    ...
    @XmlElementRef(name = "DefaultValue", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "TestCaseParameterId", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", type = JAXBElement.class, required = false)
