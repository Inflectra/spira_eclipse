...
@XmlType(name = "RemoteBuildSourceCode", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", propOrder = {
    "buildId",
    "creationDate",
    "revisionKey"
})
public class RemoteBuildSourceCode {
    ...
    @XmlElementRef(name = "RevisionKey", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", type = JAXBElement.class, required = false)
