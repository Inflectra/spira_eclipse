...
@XmlRootElement(name = "Connection_Authenticate3")
public class ConnectionAuthenticate3 {
    ...
    @XmlElementRef(name = "apiKey", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
