...
@XmlType(name = "RemoteDocumentFolder", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", propOrder = {
    "indentLevel",
    "name",
...
public class RemoteDocumentFolder {
    ...
    @XmlElementRef(name = "ParentProjectAttachmentFolderId", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", type = JAXBElement.class, required = false)
    ...
    public void setParentProjectAttachmentFolderId(JAXBElement<Integer> value) {
        this.parentProjectAttachmentFolderId = value;
    }
