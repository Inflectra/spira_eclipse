 ...
 *       &lt;sequence>
 *         &lt;element name="AutomationHost_CreateResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}RemoteAutomationHost" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AutomationHostCreateResponse {
    ...
    @XmlElementRef(name = "AutomationHost_CreateResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setAutomationHostCreateResult(JAXBElement<RemoteAutomationHost> value) {
        this.automationHostCreateResult = value;
    }
