 ...
 *       &lt;sequence>
 *         &lt;element name="Build_RetrieveByIdResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}RemoteBuild" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class BuildRetrieveByIdResponse {
    ...
    @XmlElementRef(name = "Build_RetrieveByIdResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setBuildRetrieveByIdResult(JAXBElement<RemoteBuild> value) {
        this.buildRetrieveByIdResult = value;
    }
