 ...
 *       &lt;sequence>
 *         &lt;element name="remoteDocumentFolder" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}RemoteDocumentFolder" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "Document_UpdateFolder")
public class DocumentUpdateFolder {

    @XmlElementRef(name = "remoteDocumentFolder", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setRemoteDocumentFolder(JAXBElement<RemoteDocumentFolder> value) {
        this.remoteDocumentFolder = value;
    }
