 ...
 *       &lt;sequence>
 *         &lt;element name="Incident_RetrieveByTestRunStepResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteIncident" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class IncidentRetrieveByTestRunStepResponse {
    ...
    @XmlElementRef(name = "Incident_RetrieveByTestRunStepResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setIncidentRetrieveByTestRunStepResult(JAXBElement<ArrayOfRemoteIncident> value) {
        this.incidentRetrieveByTestRunStepResult = value;
    }
