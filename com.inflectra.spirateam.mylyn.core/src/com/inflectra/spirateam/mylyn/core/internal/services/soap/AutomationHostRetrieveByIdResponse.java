 ...
 *       &lt;sequence>
 *         &lt;element name="AutomationHost_RetrieveByIdResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}RemoteAutomationHost" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AutomationHostRetrieveByIdResponse {
    ...
    @XmlElementRef(name = "AutomationHost_RetrieveByIdResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setAutomationHostRetrieveByIdResult(JAXBElement<RemoteAutomationHost> value) {
        this.automationHostRetrieveByIdResult = value;
    }
