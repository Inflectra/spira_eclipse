...
@XmlType(name = "RemoteArtifactSubscription", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", propOrder = {
    "artifactDescription",
    "artifactId",
    "artifactName",
    "artifactTypeId",
...
public class RemoteArtifactSubscription {
    ...
    @XmlElementRef(name = "ArtifactDescription", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", type = JAXBElement.class, required = false)
    protected JAXBElement<String> artifactDescription;
    ...
    /**
     * Gets the value of the artifactDescription property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getArtifactDescription() {
        return artifactDescription;
    }

    /**
     * Sets the value of the artifactDescription property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setArtifactDescription(JAXBElement<String> value) {
