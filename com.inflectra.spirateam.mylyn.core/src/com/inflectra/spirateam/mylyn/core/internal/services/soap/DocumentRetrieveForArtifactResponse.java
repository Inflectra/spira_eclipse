 ...
 *       &lt;sequence>
 *         &lt;element name="Document_RetrieveForArtifactResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteDocument" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DocumentRetrieveForArtifactResponse {
    ...
    @XmlElementRef(name = "Document_RetrieveForArtifactResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setDocumentRetrieveForArtifactResult(JAXBElement<ArrayOfRemoteDocument> value) {
        this.documentRetrieveForArtifactResult = value;
    }
