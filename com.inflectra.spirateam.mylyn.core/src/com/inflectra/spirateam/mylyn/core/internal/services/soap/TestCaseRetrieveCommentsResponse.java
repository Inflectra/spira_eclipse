 ...
 *       &lt;sequence>
 *         &lt;element name="TestCase_RetrieveCommentsResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteComment" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TestCaseRetrieveCommentsResponse {
    ...
    @XmlElementRef(name = "TestCase_RetrieveCommentsResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setTestCaseRetrieveCommentsResult(JAXBElement<ArrayOfRemoteComment> value) {
        this.testCaseRetrieveCommentsResult = value;
    }
