 ...
 *       &lt;sequence>
 *         &lt;element name="CustomProperty_RetrieveCustomListsResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteCustomList" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CustomPropertyRetrieveCustomListsResponse {
    ...
    @XmlElementRef(name = "CustomProperty_RetrieveCustomListsResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setCustomPropertyRetrieveCustomListsResult(JAXBElement<ArrayOfRemoteCustomList> value) {
        this.customPropertyRetrieveCustomListsResult = value;
    }
