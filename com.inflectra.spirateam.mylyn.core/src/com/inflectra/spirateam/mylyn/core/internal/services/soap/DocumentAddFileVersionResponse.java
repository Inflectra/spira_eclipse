 ...
 *       &lt;sequence>
 *         &lt;element name="Document_AddFileVersionResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v4_0.DataObjects}RemoteDocumentVersion" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DocumentAddFileVersionResponse {
    ...
    @XmlElementRef(name = "Document_AddFileVersionResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v4.0/", type = JAXBElement.class)
    ...
    public void setDocumentAddFileVersionResult(JAXBElement<RemoteDocumentVersion> value) {
        this.documentAddFileVersionResult = ((JAXBElement<RemoteDocumentVersion> ) value);
    }
