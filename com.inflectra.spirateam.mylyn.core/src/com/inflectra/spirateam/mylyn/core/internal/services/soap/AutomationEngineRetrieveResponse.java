 ...
 *       &lt;sequence>
 *         &lt;element name="AutomationEngine_RetrieveResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteAutomationEngine" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AutomationEngineRetrieveResponse {
    ...
    @XmlElementRef(name = "AutomationEngine_RetrieveResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setAutomationEngineRetrieveResult(JAXBElement<ArrayOfRemoteAutomationEngine> value) {
        this.automationEngineRetrieveResult = value;
    }
