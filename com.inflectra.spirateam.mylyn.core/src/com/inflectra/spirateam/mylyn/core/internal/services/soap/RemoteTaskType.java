...
@XmlType(name = "RemoteTaskType", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", propOrder = {
    "active",
    "name",
    "position",
    "taskTypeId",
