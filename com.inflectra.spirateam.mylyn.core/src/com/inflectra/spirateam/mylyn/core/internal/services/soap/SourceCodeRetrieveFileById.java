...
@XmlRootElement(name = "SourceCode_RetrieveFileById")
public class SourceCodeRetrieveFileById {
    ...
    @XmlElementRef(name = "fileId", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
