 ...
 *       &lt;sequence>
 *         &lt;element name="Document_RetrieveFolderByIdResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}RemoteDocumentFolder" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DocumentRetrieveFolderByIdResponse {
    ...
    @XmlElementRef(name = "Document_RetrieveFolderByIdResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setDocumentRetrieveFolderByIdResult(JAXBElement<RemoteDocumentFolder> value) {
        this.documentRetrieveFolderByIdResult = value;
    }
