 ...
 *       &lt;sequence>
 *         &lt;element name="Task_CreateCommentResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}RemoteComment" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TaskCreateCommentResponse {
    ...
    @XmlElementRef(name = "Task_CreateCommentResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setTaskCreateCommentResult(JAXBElement<RemoteComment> value) {
        this.taskCreateCommentResult = value;
    }
