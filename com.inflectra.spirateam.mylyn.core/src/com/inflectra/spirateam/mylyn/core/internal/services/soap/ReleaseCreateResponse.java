 ...
 *       &lt;sequence>
 *         &lt;element name="Release_CreateResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}RemoteRelease" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ReleaseCreateResponse {
    ...
    @XmlElementRef(name = "Release_CreateResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setReleaseCreateResult(JAXBElement<RemoteRelease> value) {
        this.releaseCreateResult = value;
    }
