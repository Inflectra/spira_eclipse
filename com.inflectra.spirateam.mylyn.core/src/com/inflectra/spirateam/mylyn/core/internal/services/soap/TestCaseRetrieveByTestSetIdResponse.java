 ...
 *       &lt;sequence>
 *         &lt;element name="TestCase_RetrieveByTestSetIdResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v4_0.DataObjects}ArrayOfRemoteTestCase" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TestCaseRetrieveByTestSetIdResponse {
    ...
    @XmlElementRef(name = "TestCase_RetrieveByTestSetIdResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v4.0/", type = JAXBElement.class)
