 ...
 *       &lt;sequence>
 *         &lt;element name="Incident_RetrievePrioritiesResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteIncidentPriority" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class IncidentRetrievePrioritiesResponse {
    ...
    @XmlElementRef(name = "Incident_RetrievePrioritiesResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
