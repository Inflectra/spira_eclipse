...
@XmlRootElement(name = "AutomationHost_RetrieveById")
public class AutomationHostRetrieveById {

    protected Integer automationHostId;
     ...
     *     
     */
    public Integer getAutomationHostId() {
     ...
     *     
     */
    public void setAutomationHostId(Integer value) {
