 ...
 *       &lt;sequence>
 *         &lt;element name="TestCase_RetrieveStepParametersResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteTestStepParameter" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TestCaseRetrieveStepParametersResponse {
    ...
    @XmlElementRef(name = "TestCase_RetrieveStepParametersResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setTestCaseRetrieveStepParametersResult(JAXBElement<ArrayOfRemoteTestStepParameter> value) {
        this.testCaseRetrieveStepParametersResult = value;
    }
