...
@XmlRootElement(name = "TestSet_RetrieveByFolder")
public class TestSetRetrieveByFolder {

    @XmlElementRef(name = "testSetFolderId", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
