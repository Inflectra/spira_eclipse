...
public class ISoapServiceSubscriptionRetrieveForUserServiceFaultMessageFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public ISoapServiceSubscriptionRetrieveForUserServiceFaultMessageFaultFaultMessage(String message, ServiceFaultMessage faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ISoapServiceSubscriptionRetrieveForUserServiceFaultMessageFaultFaultMessage(String message, ServiceFaultMessage faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
