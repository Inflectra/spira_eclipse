 ...
 *       &lt;sequence>
 *         &lt;element name="DateRangeValue" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}DateRange" minOccurs="0"/>
 *         &lt;element name="IntValue" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 *         &lt;element name="MultiValue" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}MultiValueFilter" minOccurs="0"/>
...
@XmlType(name = "RemoteFilter", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", propOrder = {
    "dateRangeValue",
    "intValue",
    "multiValue",
    "propertyName",
...
public class RemoteFilter {
    ...
    @XmlElementRef(name = "DateRangeValue", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", type = JAXBElement.class, required = false)
    protected JAXBElement<DateRange> dateRangeValue;
    @XmlElementRef(name = "IntValue", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> intValue;
    @XmlElementRef(name = "MultiValue", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", type = JAXBElement.class, required = false)
    protected JAXBElement<MultiValueFilter> multiValue;
    @XmlElementRef(name = "PropertyName", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", type = JAXBElement.class, required = false)
