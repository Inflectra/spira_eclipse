 ...
 *       &lt;sequence>
 *         &lt;element name="TestRun_RecordAutomated3Result" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteAutomatedTestRun" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TestRunRecordAutomated3Response {
    ...
    @XmlElementRef(name = "TestRun_RecordAutomated3Result", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setTestRunRecordAutomated3Result(JAXBElement<ArrayOfRemoteAutomatedTestRun> value) {
        this.testRunRecordAutomated3Result = value;
    }
