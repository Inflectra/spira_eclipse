...
@XmlType(name = "RemoteTestSetFolder", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", propOrder = {
    "actualDuration",
    "countBlocked",
    "countCaution",
    "countFailed",
...
public class RemoteTestSetFolder {
    ...
    @XmlElementRef(name = "ParentTestSetFolderId", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", type = JAXBElement.class, required = false)
