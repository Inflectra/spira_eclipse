 ...
 *       &lt;sequence>
 *         &lt;element name="Incident_RetrieveForOwnerResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteIncident" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class IncidentRetrieveForOwnerResponse {
    ...
    @XmlElementRef(name = "Incident_RetrieveForOwnerResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setIncidentRetrieveForOwnerResult(JAXBElement<ArrayOfRemoteIncident> value) {
        this.incidentRetrieveForOwnerResult = value;
    }
