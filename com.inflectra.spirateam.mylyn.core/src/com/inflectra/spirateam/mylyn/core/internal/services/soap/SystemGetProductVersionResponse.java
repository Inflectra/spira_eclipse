 ...
 *       &lt;sequence>
 *         &lt;element name="System_GetProductVersionResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v4_0.DataObjects}RemoteVersion" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SystemGetProductVersionResponse {
    ...
    @XmlElementRef(name = "System_GetProductVersionResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v4.0/", type = JAXBElement.class)
