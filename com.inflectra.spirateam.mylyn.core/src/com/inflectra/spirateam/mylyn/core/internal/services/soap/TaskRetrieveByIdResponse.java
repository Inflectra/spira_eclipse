 ...
 *       &lt;sequence>
 *         &lt;element name="Task_RetrieveByIdResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}RemoteTask" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TaskRetrieveByIdResponse {
    ...
    @XmlElementRef(name = "Task_RetrieveByIdResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setTaskRetrieveByIdResult(JAXBElement<RemoteTask> value) {
        this.taskRetrieveByIdResult = value;
    }
