...
@XmlType(name = "RemoteTestStep", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", propOrder = {
    "description",
    "executionStatusId",
    "expectedResult",
    "lastUpdateDate",
    ...
    extends RemoteArtifact
{
    ...
    @XmlElementRef(name = "LinkedTestCaseId", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", type = JAXBElement.class, required = false)
