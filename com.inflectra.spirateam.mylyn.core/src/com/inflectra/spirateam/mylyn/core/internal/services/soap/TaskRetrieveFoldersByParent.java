...
@XmlRootElement(name = "Task_RetrieveFoldersByParent")
public class TaskRetrieveFoldersByParent {

    @XmlElementRef(name = "parentTaskFolderId", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
