 ...
 *       &lt;sequence>
 *         &lt;element name="TestSet_AddTestMappingResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteTestSetTestCaseMapping" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TestSetAddTestMappingResponse {
    ...
    @XmlElementRef(name = "TestSet_AddTestMappingResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setTestSetAddTestMappingResult(JAXBElement<ArrayOfRemoteTestSetTestCaseMapping> value) {
        this.testSetAddTestMappingResult = value;
    }
