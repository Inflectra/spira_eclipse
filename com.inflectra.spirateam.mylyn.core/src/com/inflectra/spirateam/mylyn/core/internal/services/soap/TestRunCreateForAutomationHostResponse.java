 ...
 *       &lt;sequence>
 *         &lt;element name="TestRun_CreateForAutomationHostResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteAutomatedTestRun" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TestRunCreateForAutomationHostResponse {
    ...
    @XmlElementRef(name = "TestRun_CreateForAutomationHostResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setTestRunCreateForAutomationHostResult(JAXBElement<ArrayOfRemoteAutomatedTestRun> value) {
        this.testRunCreateForAutomationHostResult = value;
    }
