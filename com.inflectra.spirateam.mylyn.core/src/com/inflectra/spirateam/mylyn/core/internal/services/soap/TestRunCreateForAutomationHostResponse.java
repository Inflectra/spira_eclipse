 ...
 *       &lt;sequence>
 *         &lt;element name="TestRun_CreateForAutomationHostResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v4_0.DataObjects}ArrayOfRemoteAutomatedTestRun" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TestRunCreateForAutomationHostResponse {
    ...
    @XmlElementRef(name = "TestRun_CreateForAutomationHostResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v4.0/", type = JAXBElement.class)
