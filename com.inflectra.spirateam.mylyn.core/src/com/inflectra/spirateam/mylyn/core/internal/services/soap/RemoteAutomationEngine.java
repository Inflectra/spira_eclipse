...
@XmlType(name = "RemoteAutomationEngine", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v4_0.DataObjects", propOrder = {
    "active",
    "automationEngineId",
    "description",
    "name",
...
public class RemoteAutomationEngine {
    ...
    @XmlElementRef(name = "Token", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v4_0.DataObjects", type = JAXBElement.class)
