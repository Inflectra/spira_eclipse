 ...
 *       &lt;sequence>
 *         &lt;element name="Incident_RetrieveByTestCaseResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteIncident" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class IncidentRetrieveByTestCaseResponse {
    ...
    @XmlElementRef(name = "Incident_RetrieveByTestCaseResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setIncidentRetrieveByTestCaseResult(JAXBElement<ArrayOfRemoteIncident> value) {
        this.incidentRetrieveByTestCaseResult = value;
    }
