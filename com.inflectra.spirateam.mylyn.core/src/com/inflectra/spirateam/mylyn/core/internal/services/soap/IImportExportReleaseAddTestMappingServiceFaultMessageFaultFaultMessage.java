    ...
    extends Exception
{
     ...
     * @param faultInfo
     */
    public IImportExportReleaseAddTestMappingServiceFaultMessageFaultFaultMessage(String message, ServiceFaultMessage faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public IImportExportReleaseAddTestMappingServiceFaultMessageFaultFaultMessage(String message, ServiceFaultMessage faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
