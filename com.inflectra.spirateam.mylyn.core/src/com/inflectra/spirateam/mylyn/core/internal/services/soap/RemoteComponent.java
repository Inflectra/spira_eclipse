 ...
 * 
 * 
 * <p>Java class for RemoteComponent complex type.
 * 
...
@XmlType(name = "RemoteComponent", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects", propOrder = {
    "componentId",
    "isActive",
    "isDeleted",
    "name",
