...
@XmlType(name = "RemoteDataMapping", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v4_0.DataObjects", propOrder = {
    "externalKey",
    "internalId",
    "primary",
    "projectId"
...
public class RemoteDataMapping {
    ...
    @XmlElementRef(name = "ExternalKey", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v4_0.DataObjects", type = JAXBElement.class)
