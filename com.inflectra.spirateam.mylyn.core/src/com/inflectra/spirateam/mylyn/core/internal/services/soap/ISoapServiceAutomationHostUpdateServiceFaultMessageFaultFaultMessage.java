...
public class ISoapServiceAutomationHostUpdateServiceFaultMessageFaultFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public ISoapServiceAutomationHostUpdateServiceFaultMessageFaultFaultMessage(String message, ServiceFaultMessage faultInfo) {
        super(message);
     ...
     * @param message
     */
    public ISoapServiceAutomationHostUpdateServiceFaultMessageFaultFaultMessage(String message, ServiceFaultMessage faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
