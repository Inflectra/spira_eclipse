 ...
 *       &lt;sequence>
 *         &lt;element name="CustomProperty_AddDefinitionResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v4_0.DataObjects}RemoteCustomProperty" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CustomPropertyAddDefinitionResponse {
    ...
    @XmlElementRef(name = "CustomProperty_AddDefinitionResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v4.0/", type = JAXBElement.class)
    ...
    public void setCustomPropertyAddDefinitionResult(JAXBElement<RemoteCustomProperty> value) {
        this.customPropertyAddDefinitionResult = ((JAXBElement<RemoteCustomProperty> ) value);
    }
