 ...
 *       &lt;sequence>
 *         &lt;element name="Requirement_RetrieveTestCoverageResult" type="{http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v5_0.DataObjects}ArrayOfRemoteRequirementTestCaseMapping" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RequirementRetrieveTestCoverageResponse {
    ...
    @XmlElementRef(name = "Requirement_RetrieveTestCoverageResult", namespace = "http://www.inflectra.com/SpiraTest/Services/v5.0/", type = JAXBElement.class, required = false)
    ...
    public void setRequirementRetrieveTestCoverageResult(JAXBElement<ArrayOfRemoteRequirementTestCaseMapping> value) {
        this.requirementRetrieveTestCoverageResult = value;
    }
